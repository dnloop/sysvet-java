...
public class ShowController {
    ...
    static ExamenGeneralHome dao = new ExamenGeneralHome();
    ...
    void initialize() {
        ...
        JFXTreeTableColumn<ExamenGeneral, String> amplitud = new JFXTreeTableColumn<ExamenGeneral, String>("Amplitud");
        ...
        JFXTreeTableColumn<ExamenGeneral, String> escleral = new JFXTreeTableColumn<ExamenGeneral, String>("Escleral");
        ...
        JFXTreeTableColumn<ExamenGeneral, String> palperal = new JFXTreeTableColumn<ExamenGeneral, String>("Palperal");
        ...
        JFXTreeTableColumn<ExamenGeneral, String> peneana = new JFXTreeTableColumn<ExamenGeneral, String>("Peneana");
        ...
        JFXTreeTableColumn<ExamenGeneral, String> inguinal = new JFXTreeTableColumn<ExamenGeneral, String>("Inguinal");
        ...
        JFXTreeTableColumn<ExamenGeneral, String> popliteo = new JFXTreeTableColumn<ExamenGeneral, String>("Popliteo");
        ...
        examenList = loadTable(examenList);
    ...
    static ObservableList<ExamenGeneral> loadTable(ObservableList<ExamenGeneral> examenList) {
        List<ExamenGeneral> list = dao.displayRecords();
